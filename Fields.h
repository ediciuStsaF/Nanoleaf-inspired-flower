...
//##############################################
String getFlowerMode() {
  return String(isFlower);
}
...
FieldList fields = {
  ...
  //##############################################
  { "FlowerMode", "Flower Mode", BooleanFieldType, 0, 1, getFlowerMode },
  { "istimeoff", "Auto Time off", NumberFieldType, 0, 60, getistimeoff },
  //##############################################
